<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="DATSYS.TradingModel.RegressionWebClient.Account.OpenAuthProviders" %>
